...
Document version **2.3** · Written 16 September 2026 · Transposed onto the NHS England template and verified 17 September 2026 · Action-plan dates re-aligned 18 September 2026
...
|---|---|---|---|---|---|
| R-06 | Publish the worker-facing privacy notice (Annex B) in the product and the repo | Author | Author | **Immediate — before October** | Outstanding |
...
> **Status: drafted, not yet published.** This closes **R-06** on adoption. It should be shown to
